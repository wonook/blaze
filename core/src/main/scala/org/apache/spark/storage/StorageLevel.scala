...
//  val MEMORY_ONLY_SER_2 = new StorageLevel(false, true, false, false, 2)
  ...
  val MEMORY_ONLY_2 = new StorageLevel(true, true, false, true, 2)
  val MEMORY_ONLY_SER = new StorageLevel(true, true, false, false)
  val MEMORY_ONLY_SER_2 = new StorageLevel(true, true, false, false, 2)
