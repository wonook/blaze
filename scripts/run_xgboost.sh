#!/bin/bash
XGBOOST_SPARK_JAR="/home/ubuntu/xgboost/jvm-packages/xgboost4j-spark/target/xgboost4j-spark_2.12-1.0.0-SNAPSHOT.jar"
...
/home/ubuntu/xgboost/jvm-packages/xgboost4j-example/target/xgboost4j-example_2.12-1.0.0-SNAPSHOT.jar \
iris.data \
2>&1 | tee log_xgboost
